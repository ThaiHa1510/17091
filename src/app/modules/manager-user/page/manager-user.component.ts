...
import { UserService, AlertService, ModelService } from '@/_servies';
...
export class ManagerUserComponent implements OnInit, AfterViewInit {
  ...
  assigned: string = '';
  displayedColumns: string[] = ['select', 'email', 'name', 'role', 'ipAddress', 'status', 'createdAt', 'token', 'actions'];
