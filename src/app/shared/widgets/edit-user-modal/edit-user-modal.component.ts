...
export class EditUserModalComponent implements OnInit {
  ...
  updateCommission(){
      if (this.commissionFormGroup.invalid) {
      return;
    }
    let dataInsert = this.commissionFormGroup.value;
    
     this.modelService.updateCommission(this.user.id, dataInsert)
      .subscribe(data => {
     
        this.alertService.success('Saved Successfully');
        this.user.commission  = dataInsert.commission;
        this.dialogRef.close()
